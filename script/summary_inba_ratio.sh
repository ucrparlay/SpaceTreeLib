...
echo "ratio build1 maxdepth1 averagedepth1 1nn1 visnodeNum1 5nn1 visnodeNum1 100nn1 visnodeNum1 build2 maxdepth2 averagedepth2 1nn2 visnodeNum2 5nn2 visnodeNum2 100nn2 visnodeNum2"
# echo "build1 maxdepth1 averagedepth1 rc1 build2 maxdepth2 averagedepth2 rc2 build3 maxdepth3 averagedepth3 rc3"
# echo "build1 maxdepth1 averagedepth1 rc1 build2 maxdepth2 averagedepth2 rc2"
counter=0
cnt=0
