...
input_path = "logs/incre_update_3d/" + input_type + ".log"
store_path = "data/incre_update_3d/" + input_type + ".csv"
type = ""
...
subprocess.run(
    f"cat $(ls logs/incre_update_3d/*{input_type}* | grep -v -e {input_type}.log -e {input_type}_2_4_0.log) > logs/incre_update_3d/{input_type}.log",
    shell=True,
)

csv_writer, csv_file_pointer = csvSetup()
data = combine(input_path)
# data = data + combine_boost("logs/incre_update_3d/"+input_type+"_2_4_0.log")
# print(data)
