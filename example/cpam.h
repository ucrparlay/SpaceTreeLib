...
// Example usage of CpamRaw (CPAM baseline) from SpaceTreeLib
// CPAM is a baseline implementation using Compressed Purely Functional
// Augmented Maps with space-filling curves

namespace cpam_example {

using Coord = long;

// Define augmentation structure for points with space-filling curve code
// WARN: All functions must be defined
// CPAM requires AugIdCode which includes both an id and a curve code
struct AugIdCode {
...
// Define CpamRaw type (baseline implementation)
using Tree = CPAMTree::CpamRaw<Point, SplitRule>;
