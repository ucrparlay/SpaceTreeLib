...
class q_intelementCompare {
    ...
    */
    bool operator()(const std::pair<vtx*, double> p1, const std::pair<vtx*, double> p2) {
...
class qknn {
   private:
    ...
    typedef std::priority_queue<q_intelement, std::vector<q_intelement>, q_intelementCompare<vtx>> PQ;
    PQ pq;
