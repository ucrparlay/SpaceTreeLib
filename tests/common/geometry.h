...
public:
	...
	vector3d(point p);
	vector3d(parlay::slice<coord *, coord *> p)
	    : x(p[0]), y(p[1]), z(p[2]) {};
...
public:
	...
	point3d(parlay::slice<coord *, coord *> p)
	    : x(p[0]), y(p[1]), z(p[2]) {};
	void print()
	{
		cout << ":(" << x << "," << y << "," << z << "):";
...
template <class coord>
static std::ostream &operator<<(std::ostream &os, vector3d<coord> const v)
{
	return os << v.x << " " << v.y << " " << v.z;
}

template <class coord>
static std::ostream &operator<<(std::ostream &os, point3d<coord> const v)
{
	return os << v.x << " " << v.y << " " << v.z;
}
...
template <class coord>
static std::ostream &operator<<(std::ostream &os, vector2d<coord> const v)
{
	return os << v.x << " " << v.y;
}

template <class coord>
static std::ostream &operator<<(std::ostream &os, point2d<coord> const v)
{
	return os << v.x << " " << v.y;
}
					   ...
					   point2d<coord> c)
{
	...
	return a + vector2d<coord>(v22.y - v11.y, v11.x - v22.x) /
			   (2.0 * v1.cross(v2));
}
