#ifndef PSTP_COVER_TREE_IMPL_COVER_BATCH_DELETE_HPP_
#define PSTP_COVER_TREE_IMPL_COVER_BATCH_DELETE_HPP_
...
#endif  // PSTP_COVER_TREE_IMPL_COVER_BATCH_DELETE_HPP_
