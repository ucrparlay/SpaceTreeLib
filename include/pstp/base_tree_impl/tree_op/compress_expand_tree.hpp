#ifndef PSTP_BASE_TREE_IMPL_COMPRESS_EXPAND_TREE_HPP_
#define PSTP_BASE_TREE_IMPL_COMPRESS_EXPAND_TREE_HPP_
...
#endif  // PSTP_BASE_TREE_IMPL_COMPRESS_EXPAND_TREE_HPP_
