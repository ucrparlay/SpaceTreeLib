...
// inline BaseTree<Point>::DimsType BaseTree<Point>::PickRebuildDim(
//     const Node* T, const DimsType d, const DimsType DIM) {
//     PickRebuildDim_(T, d, DIM, SplitRule());
// }
//
// template<typename Point>
// inline BaseTree<Point>::DimsType BaseTree<Point>::PickRebuildDim_(
...
// template<typename Point>
// inline BaseTree<Point>::DimsType BaseTree<Point>::PickMaxStretchDim(
//     const Box& bx) {
//     DimsType d(0);
