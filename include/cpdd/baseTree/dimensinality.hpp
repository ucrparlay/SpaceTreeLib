...
template<typename point>
inline BaseTree<point>::dim_type BaseTree<point>::pick_rebuild_dim(const node* T, const dim_type d,
                                                                   const dim_type DIM) {
...
template<typename point>
inline BaseTree<point>::dim_type BaseTree<point>::pick_max_stretch_dim(const box& bx, const dim_type DIM) {
    dim_type d(0);
