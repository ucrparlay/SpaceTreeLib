#ifndef PSI_POINTER_VIEW_BASE_TREE_IMPL_INNER_TREE_INNER_TREE_COMMON_HPP_
#define PSI_POINTER_VIEW_BASE_TREE_IMPL_INNER_TREE_INNER_TREE_COMMON_HPP_
...
#endif  // PSI_POINTER_VIEW_BASE_TREE_IMPL_INNER_TREE_INNER_TREE_COMMON_HPP_
