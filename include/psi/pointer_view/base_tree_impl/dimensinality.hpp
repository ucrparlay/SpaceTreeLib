#ifndef PSI_POINTER_VIEW_BASE_TREE_IMPL_DIMENSINALITY_HPP_
#define PSI_POINTER_VIEW_BASE_TREE_IMPL_DIMENSINALITY_HPP_
...
#endif  // PSI_POINTER_VIEW_BASE_TREE_IMPL_DIMENSINALITY_HPP_
