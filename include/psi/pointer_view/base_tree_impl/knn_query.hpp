#ifndef PSI_POINTER_VIEW_BASE_TREE_IMPL_KNN_QUERY_HPP_
#define PSI_POINTER_VIEW_BASE_TREE_IMPL_KNN_QUERY_HPP_
...
#endif  // PSI_POINTER_VIEW_BASE_TREE_IMPL_KNN_QUERY_HPP_
