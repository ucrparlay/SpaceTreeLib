#ifndef PSI_POINTER_VIEW_ORTH_TREE_IMPL_ORTH_BATCH_DIFF_HPP_
#define PSI_POINTER_VIEW_ORTH_TREE_IMPL_ORTH_BATCH_DIFF_HPP_
...
#endif  // PSI_POINTER_VIEW_ORTH_TREE_IMPL_ORTH_BATCH_DIFF_HPP_
