#ifndef PSI_POINTER_VIEW_KD_TREE_IMPL_KD_OVERRIDE_HPP_
#define PSI_POINTER_VIEW_KD_TREE_IMPL_KD_OVERRIDE_HPP_
...
#endif  // PSI_POINTER_VIEW_KD_TREE_IMPL_KD_OVERRIDE_HPP_
