#ifndef PSI_ARRAY_BASED_ORTH_TREE_ARRAY_H_
#define PSI_ARRAY_BASED_ORTH_TREE_ARRAY_H_
...
class OrthTreeArray 
    : public BaseTreeArray<Point,
                           OrthTreeArray<Point, SplitRule, LeafAugType, 
                                         InteriorAugType, kMD, kSkHeight,
                                         kImbaRatio>,
 ...
 public:
  ...
  struct CompactMultiNode {
    ...
    CompactMultiNode() : size(0), is_leaf(false), 
...
#endif  // PSI_ARRAY_BASED_ORTH_TREE_ARRAY_H_
