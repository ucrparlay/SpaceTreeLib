#ifndef PSPT_COVER_TREE_IMPL_COVER_BATCH_DELETE_HPP_
#define PSPT_COVER_TREE_IMPL_COVER_BATCH_DELETE_HPP_
...
#endif  // PSPT_COVER_TREE_IMPL_COVER_BATCH_DELETE_HPP_
