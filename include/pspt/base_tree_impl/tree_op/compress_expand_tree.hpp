#ifndef PSPT_BASE_TREE_IMPL_COMPRESS_EXPAND_TREE_HPP_
#define PSPT_BASE_TREE_IMPL_COMPRESS_EXPAND_TREE_HPP_
...
#endif  // PSPT_BASE_TREE_IMPL_COMPRESS_EXPAND_TREE_HPP_
