#ifndef PSPT_R_TREE_H
#define PSPT_R_TREE_H
...
class RTree
    : public BaseTree<Point, RTree<Point, SplitRule, kSkHeight, kImbaRatio>,
 ...
 public:
  ...
  using Leaf =
      LeafNode<Point, Slice, BT::kLeaveWrap, Box, parlay::move_assign_tag>;
