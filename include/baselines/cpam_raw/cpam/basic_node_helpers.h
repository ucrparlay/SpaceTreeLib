...
two_compressed_nodes(typename Node::ET *stack, size_t tot, size_t B,
		     typename Node::regular_node *e = nullptr)
{
	assert(tot >= (2 * B + 1));
	size_t left_size = tot / 2, right_size = tot / 2 - (!(tot & 1));
	if (e == nullptr)
		e = Node::single(stack[left_size]);
...
template <class Node>
static typename Node::node *
four_compressed_nodes(typename Node::ET *stack, size_t tot, size_t B,
		      typename Node::regular_node *e = nullptr)
{
